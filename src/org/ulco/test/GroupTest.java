...
public class GroupTest extends TestCase {
    ...
    public void testJson() throws Exception {
        ...
        g.add(s);
        g.add(c);
        assertEquals(JSON.jsonParsable(g), "{ type: group, objects : { { type: square, center: { type: point, x: 0.0, y: 0.0 }, length: 5.0 }, " +
    ...
    public void testJson2() throws Exception {
        ...
        g2.add(g);
        g2.add(r);
        assertEquals(JSON.jsonParsable(g2), "{ type: group, objects : { { type: rectangle, center: { type: point, x: -6.0, y: 10.0 }, " +
